...
//	specialKey = glutGetModifiers();
	...
	gluLookAt(cameraX, (int)(heightmap[(int)cameraX, (int)cameraY])-10, cameraY-10,
			cameraX, (int)(heightmap[(int)cameraX, (int)cameraY]), cameraY,
			0.0f, 1.0f, 0.0f);
	glutSwapBuffers();
...
int main(int argc, char** argv) 
{
	...
	//Create the window
	glutCreateWindow("RTS - Ben Cargill");
